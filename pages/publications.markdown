...
![Profile Photo]({{ "/assets/phd_paper2.png" | relative_url }})
...
![Profile Photo]({{ "/assets/phd_paper3.png" | relative_url }})
...
## [A 3D human whole-body model with integrated organs vasculature musculoskeletal and nervous systems for mapping nerves]({{ "/publications/abi_paper_1/" | relative_url }})

![Profile Photo]({{ "/assets/ABI_paper1.jpeg" | relative_url }})

{% include buttons.html 
   article_url="https://doi.org/10.26275/bbvg-gj86"
   dataset_url="https://sparc.science/datasets/307/version/8?datasetDetailsTab=files" %}
